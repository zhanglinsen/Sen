package com.codeazur.as3swf.data
{
	...
	{
		protected var _initialFillStyles:Array;
		protected var _initialLineStyles:Array;
		
		public function SWFShapeWithStyle(data:SWFData = null, level:uint = 1, unitDivisor:Number = 20) {
			_initialFillStyles = new Array();
			_initialLineStyles = new Array();
			super(data, level, unitDivisor);
		}
		
		public function get initialFillStyles():Array { return _initialFillStyles; }
		public function get initialLineStyles():Array { return _initialLineStyles; }
