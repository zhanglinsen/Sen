package apparat.lzma {
	...
	public final class LZMADecoder {
		...
		private var _isMatchDecoders: Array = new Array(Base.kNumStates << Base.kNumPosStatesBitsMax)
		private var _isRepDecoders: Array = new Array(Base.kNumStates)
		private var _isRepG0Decoders: Array = new Array(Base.kNumStates)
		private var _isRepG1Decoders: Array = new Array(Base.kNumStates)
		private var _isRepG2Decoders: Array = new Array(Base.kNumStates)
		private var _isRep0LongDecoders: Array = new Array(Base.kNumStates << Base.kNumPosStatesBitsMax)
		private var _posSlotDecoder: Array = new Array(Base.kNumLenToPosStates)
		private var _posDecoders: Array = new Array(Base.kNumFullDistances - Base.kEndPosModelIndex)
		...
		public function setDecoderProperties(properties: Array): Boolean {
